...
//			runTest(session, "scaledas7-bdecoste26e.dev.rhcloud.com[35540]");
	...
	protected void testActiveMQ() throws Exception {
		...
		String ip = "192.168.146.133";
		String port = "47133";
		String host = "amq-demo.example.com";
		//if (host != null && host.trim().length() > 0) {
		//	ip = host;
		//	port = System.getenv("OPENSHIFT_ACTIVEMQ_OPENWIRE_PORT");
		//}
		consumeAmqMessage(host, port);
		sendAmqMessage(host, port);
	}
	...
	public class AmqConsumer implements Runnable, ExceptionListener {
        ...
        public void run() {
            try {
                ...
                // Create a Connection
                Connection connection = connectionFactory.createConnection("admin", "KSyxBbm43mae");
                connection.start();
